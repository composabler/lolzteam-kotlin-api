...
open class User(
    ...
    @JsonProperty("user_is_admin") val isAdmin: Boolean? = null,
    @JsonProperty("user_is_moderator") val isModerator: Boolean? = null,
    @JsonProperty("user_is_staff") val isStaff: Boolean? = null,
